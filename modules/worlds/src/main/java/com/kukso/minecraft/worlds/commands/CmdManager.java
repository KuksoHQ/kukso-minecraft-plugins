...
public class CmdManager implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (sub == null) {
            ...
            if (sub == null) {
                ...
                if (sender instanceof org.bukkit.entity.Player player) {
                    msg = com.kukso.minecraft.lib.modules.text.Lang.t(player, "general.unknown-subcommand", ph);
                } else {
                    msg = com.kukso.minecraft.lib.modules.text.Lang.t("general.unknown-subcommand", "en", ph);
                }
        ...
        if (!hasAnyPermission(sender, getEffectivePermissions(subCmdName, sub))) {
             String msg;
             if (sender instanceof org.bukkit.entity.Player player) {
                 msg = com.kukso.minecraft.lib.modules.text.Lang.t(player, "general.no-permission");
             } else {
                 msg = com.kukso.minecraft.lib.modules.text.Lang.t("general.no-permission", "en", Collections.emptyMap());
             }
             sender.sendMessage(msg);
             return true;
        }
