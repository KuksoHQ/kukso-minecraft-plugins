...
import com.kukso.minecraft.worlds.generator.VoidWorldGenerator;
import com.kukso.minecraft.lib.modules.logger.LoggingManager;
import com.kukso.minecraft.lib.modules.logger.PlayerLogger;
...
public class CreateCmd implements CmdInterface {
    ...
    private final LoggingManager serverLogger;
    private final PlayerLogger playerLogger;

    public CreateCmd(Main plugin) {
        this.plugin = plugin;
        this.serverLogger = new LoggingManager(plugin);
