...
import com.kukso.minecraft.worlds.commands.CmdConfig;
import com.kukso.minecraft.worlds.commands.CmdInterface;
...
public class ListCmd implements CmdInterface {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        for (Map<?, ?> world : worlds) {
            ...
            if (com.kukso.minecraft.lib.services.KuksoAPIProvider.isAvailable()) {
                com.kukso.minecraft.lib.services.KuksoAPI api = com.kukso.minecraft.lib.services.KuksoAPIProvider.get();
                if (sender instanceof org.bukkit.entity.Player player) {
                    status = api.get(player, statusKey, java.util.Collections.emptyMap());
                } else {
                    // Fallback to Lang for console/non-player since API doesn't expose locale-based 't'
                    status = com.kukso.minecraft.lib.modules.text.Lang.t(statusKey, "en", java.util.Collections.emptyMap());
                }
            } else {
