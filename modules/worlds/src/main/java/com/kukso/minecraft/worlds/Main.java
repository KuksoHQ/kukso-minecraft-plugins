...
import com.kukso.minecraft.worlds.commands.CmdRegistrar;
import com.kukso.minecraft.worlds.hooks.PlaceholderAPIExtension;
import com.kukso.minecraft.worlds.utilities.ConfigManager;
...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        try {
            ...
            if (kuksoLibLoaded && com.kukso.minecraft.lib.services.KuksoAPIProvider.isAvailable()) {
                 saveResource("lang/en.yml", false);
                 saveResource("lang/tr.yml", false);
                 com.kukso.minecraft.lib.modules.text.Lang.loadAdditional(this);
            }
