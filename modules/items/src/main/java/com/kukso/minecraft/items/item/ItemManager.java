...
public class ItemManager {
    ...
    public static void loadItems(FileConfiguration config) {
        ...
        if (itemsSection == null) {
            log.warning("[KuksoItems] No items defined in items.yml.");
            return;
        }
        ...
        for (String key : itemsSection.getKeys(false)) {
            ...
            if (material == null) {
                log.warning("[KuksoItems] Invalid material: " + materialName + " for item: " + key);
                continue;
            }
                ...
                if (nbtSection != null) {
                    ...
                    for (String configKey : nbtSection.getKeys(false)) {
                        ...
                        if ("customKey".equalsIgnoreCase(configKey)) {
                            nbtItem.setString("kuksoItems", value); // âœ… Proper internal tag
                        } else {
            ...
            log.info("[KuksoItems] Loaded item: " + key);
        }
    }
