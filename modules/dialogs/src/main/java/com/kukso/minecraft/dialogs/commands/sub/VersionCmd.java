...
public class VersionCmd implements CmdInterface {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        Plugin plugin = Bukkit.getPluginManager().getPlugin("KuksoDialogs");
        String pluginVersion = plugin != null ? plugin.getPluginMeta().getVersion() : "unknown";
        String apiVersion = KuksoDialogsAPI.getApiVersion();

        sender.sendMessage("KuksoDialogs version: " + pluginVersion);
