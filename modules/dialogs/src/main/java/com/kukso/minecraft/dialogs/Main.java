package com.kukso.minecraft.dialogs;

import com.kukso.minecraft.dialogs.commands.CmdRegistrar;
import com.kukso.minecraft.dialogs.API.KuksoDialogsAPI;
import com.kukso.minecraft.dialogs.API.addon.AddonManager;
import com.kukso.minecraft.dialogs.commands.CmdRegistrar;
import com.kukso.minecraft.dialogs.dialog.DialogActionBridge;
import com.kukso.minecraft.dialogs.dialog.DialogConfigManager;
import com.kukso.minecraft.dialogs.dialog.SimpleDialogActionRegistry;
import com.kukso.minecraft.dialogs.serverLinks.ServerLinksManager;
import com.kukso.minecraft.dialogs.utilities.ConfigManager;
...
public final class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        //if (!isKuksolexCorePresent()) {
            //getLogger().severe("KuksolexCore dependency is missing or not enabled. Disabling KuksoDialogs.");
    ...
    public void onDisable() {
        ...
        // Shutdown API
        KuksoDialogsAPI.shutdown();

        instance = null;
    }

    private boolean isKuksolexCorePresent() {
        var pm = getServer().getPluginManager();
        var plugin = pm.getPlugin("Kukso");
    ...
    private void initializeAPI() {
        ...
        KuksoDialogsAPI.bootstrap(actionRegistry, "1.0.0");
        ...
        getLogger().info("KuksoDialogs API initialized with version " + KuksoDialogsAPI.getApiVersion());
    }

    private void initializeAddonSystem() {
        // Create the addon manager
        addonManager = new AddonManager(this, KuksoDialogsAPI.getApiVersion());
