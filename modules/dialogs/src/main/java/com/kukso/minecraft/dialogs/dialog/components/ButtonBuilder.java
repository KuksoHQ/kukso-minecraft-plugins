package com.kukso.minecraft.dialogs.dialog.components;

import com.kukso.minecraft.dialogs.dialog.DialogConfigManager;
import com.kukso.minecraft.dialogs.utilities.CommandPlaceholderUtility;
...
public class ButtonBuilder {
    ...
    public ActionButton buildButton(ConfigurationSection sec, String defText, String defDesc, String defColor, int defWidth) {
        ...
        String formattedText = com.kukso.minecraft.dialogs.utilities.ColorManager.applyColorFormatting(text);
        String formattedDesc = com.kukso.minecraft.dialogs.utilities.ColorManager.applyColorFormatting(desc);
