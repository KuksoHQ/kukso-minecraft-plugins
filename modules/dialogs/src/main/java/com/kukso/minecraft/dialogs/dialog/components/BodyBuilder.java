        ...
        try {
            ...
            if (meta != null) {
                if (displayName != null && !displayName.isBlank()) {
                    ...
                    String formattedDisplayName = com.kukso.minecraft.dialogs.utilities.ColorManager.applyColorFormatting(displayName);
                ...
                if (loreObj instanceof List<?> loreList) {
                    ...
                    for (Object loreItem : loreList) {
                        if (loreItem instanceof String loreString) {
                            ...
                            String formattedLore = com.kukso.minecraft.dialogs.utilities.ColorManager.applyColorFormatting(loreString);
