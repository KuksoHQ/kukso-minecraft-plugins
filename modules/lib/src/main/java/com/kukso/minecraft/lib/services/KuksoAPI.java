...
public interface KuksoAPI {
    ...
    /**
     * Reload KuksoLib configuration and language files.
     */
    void reload();

    /**
     * Whether KuksoLib logging is enabled (from config).
     */
    ...
    /**
     * Returns the current version of KuksoLib (optional).
     */
