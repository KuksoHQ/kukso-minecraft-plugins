...
public class PacketTranslator {
    ...
    public static void init(JavaPlugin plugin, KuksoAPI api, LoggingManager logger) {
    ...
    private static void handlePacket(PacketEvent event, KuksoAPI api, LoggingManager logger) {
